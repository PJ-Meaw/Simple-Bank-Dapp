...
export default function Deposit({balance}) {
    ...
    const { data, write: handleDeposit } = useDeposit(amount*Math.pow(10,18))
    ...
    const handleSend = () =>{
        try{
            ...
            toast({
                ...
                description: "Please, enter an amount smaller than the coin of your wallet.",
                status: 'error',
                duration: 9000,
                isClosable: true,
            })
    ...
    const successful = () => {
        toast({
          ...
          description: "We've deposit coin from your wallet to current balance.",
          status: 'success',
          duration: 9000,
          isClosable: true,
        })
        ...
        <>
            {
                ...
                <div className='mx-[92px] my-[55px] font-Kanit '>
                    <div className="flex flex-row justify-between ">
                        <p className=' text-[40px]'>Deposit</p>
                        <ConnectButton/>
                    </div>
